       ...
       <Router>
         ...
         <LoadingBar height={3} color='#f11946' progress={this.state.progress}  />
          ...
          <Routes>
            ...
            <Route exact path="/tesla" element={<News setprogress={this.setprogress} key="tesla"  pagesize={this.pagesize} country="in" category="tesla"/>}/>
          </Routes>
...
export class News extends Component {
  ...
  async updateNews(){
    ...
    const url = `https://newsapi.org/v2/top-headlines?country=${this.props.country}&category=${this.props.category}&apikey=0757b630797244dbb6cd983d27f361d3&page=${this.state.page}&pageSize=${this.props.pagesize}`;
