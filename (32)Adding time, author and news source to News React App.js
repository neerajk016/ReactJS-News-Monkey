       ...
       <Router>
         ...
         <NavBar/>
          ...
          <Routes>
            ...
            <Route exact path="/tesla" element={<News key="tesla"  pagesize={5} country="in" category="tesla"/>}/>
          </Routes>
...
export class News extends Component {
  ...
  async componentDidMount(){
    let url =`https://newsapi.org/v2/top-headlines?country=${this.props.country}&category=${this.props.category}&apiKey=0757b630797244dbb6cd983d27f361d3&page=${this.state.page}&pageSize=${this.props.pagesize}`;
  ...
  handlePrevClick=async()=> {
    ...
    let url =`https://newsapi.org/v2/top-headlines?country=${this.props.country}&category=${this.props.category}&apiKey=0757b630797244dbb6cd983d27f361d3&page=${this.state.page - 1}&pageSize=${this.props.pagesize}`;
    this.setState({loading:true});
    let data = await fetch(url);
    let parsedData = await data.json()
    this.setState({loading:false});
    ...
    return (
      ...
      <div className='container my-3'>
          ...
          <div className='container my-3 d-flex justify-content-between'>
            ...
            <button disabled={this.state.page +1 > Math.ceil(this.state.totalarticles / this.props.pagesize)} type="button" className="btn btn-primary" onClick={this.handleNextClick}>Next</button>
