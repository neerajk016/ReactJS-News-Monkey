...
export class News extends Component {
  ...
  async componentDidMount(){
    let url =`https://newsapi.org/v2/top-headlines?country=in&apiKey=0757b630797244dbb6cd983d27f361d3&page=${this.state.page}&pageSize=20`;
  ...
  handlePrevClick=async()=> {
    ...
    let url =`https://newsapi.org/v2/top-headlines?country=in&apiKey=0757b630797244dbb6cd983d27f361d3&page=${this.state.page - 1}&pageSize=20`;
    let data = await fetch(url);
    let parsedData = await data.json()
